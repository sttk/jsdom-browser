...
/* eslint max-statements: ['error', 100], max-nested-callbacks: ['error', 4] */
  ...
  describe('methods', () => {
    ...
    describe('.moveTo', () => {
      ...
      it('Should not move when .isFrameWindow is true', () => {
        expect(windowConfig.isFrameWindow).to.be.true
        expect(windowConfig.isMovable).to.be.false
        expect(windowConfig.isResizable).to.be.false
      ...
      it('Should move to specified position', () => {
        ...
        expect(windowConfig.isMovable).to.be.true
        ...
        expect(window.screen.availTop).to.equal(23)
        expect(window.devicePixelRatio).to.equal(1)
        expect(windowConfig.isResizable).to.be.true
    ...
    describe('.moveBy', () => {
      ...
      it('Shoudl move to right-bottom side if specified delta are too large',
      () => {
        windowConfig.isFrameWindow = false
        expect(windowConfig.isFrameWindow).to.be.false
        expect(windowConfig.isMovable).to.be.true
